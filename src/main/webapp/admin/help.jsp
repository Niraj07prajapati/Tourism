...
/* Style for the Help & Support section */
.help-support {
    background-color: #f5f5f5;
    padding: 40px 0;
}
...
.help-support ul li a {
    color: #007bff;
    text-decoration: none;
    transition: color 0.3s;
}

.help-support ul li a:hover {
    color: #0056b3;
}

/* Style for the "Visit FAQ" button */
.btn-primary {
    background-color: #007bff;
    color: #fff;
    font-size: 16px;
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p>If you need assistance or have any questions, please feel free to contact our support team. We're here to help you.</p>
                <ul>
            ...
            <div class="col-md-6">
                ...
                <p>Before reaching out to our support team, you may find answers to your questions in our FAQ section.</p>
